...
export const NavBar = () => {
    return (
        <div className="flex flex-row justify-center sm:justify-between items-center px-6 py-3 border-b border-zinc-700">
            <div className="flex flex-row space-x-4 justify-evenly">
                ...
                <div className="sm:w-[240px] sm:bg-[#F9F9F9] flex flex-row space-x-2 items-center rounded-full">
                    <div className="sm:pl-2 justify-between flex flex-row space-x-6 items-center">
                        <Search
                            strokeWidth={1}
                            width={22}
                            height={22}
                        ...
                        />
                        <div className="text-zinc-600 sm:hidden">
                            <Bell strokeWidth={1} />
                        </div>
                    ...
                    <Input
                        className="font-semibold text-[15px] font-['Figtree'] hidden sm:flex text-zinc-600 w-[70%] h-[70%] bg-[#F9F9F9] p-2 border-none"
                        placeholder="Search"
                    />
                </div>
            </div>
            <div className="sm:flex space-x-8 flex-row items-center text-zinc-600 font-['Figtree'] hidden ">
                <div className="flex flex-row gap-x-2 items-center">
                    <SquarePen strokeWidth={1} width={22} height={22} />
                    Write
                </div>
                <div>
                    <Bell strokeWidth={1} />
