...
export const NavBar = () => {
    return (
        <div className="flex flex-row items-center justify-between px-6 py-4 sm:px-[50px] lg:px-[65px] xl:px-[130px] 2xl:px-[170px] border-b border-zinc-800">
            <div>
                <svg
            ...
            <div className="sm:flex flex-row space-x-6 items-center">
                <div className="sm:flex flex-row space-x-6 hidden text-sm font-semibold font-['Figtree']">
                    <h3>Our story</h3>
                    <h3>Membership</h3>
                    <h3>Write</h3>
                </div>
                <div className="sm:flex hidden text-sm font-semibold">
                    <h3>Sign in</h3>
                </div>
                <div>
                    <Button className="rounded-full leading-none">
                        Get started
                    </Button>
                </div>
            </div>
